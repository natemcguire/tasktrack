...
async def route(
    worker, request, accounts, identity, path, method, query, body_data, bounded_body
):
    ...
    if connection:
        ...
        client = integrations.Client(row, secret, str(data.get("account_id", "")))

...
def import_page(identity):
    return page(
        "Import work",
        f"""<main class="account-content setup-page"><a href="/account">Account settings</a><nav class="setup-nav" aria-label="Setup"><a href="/agents">Agents</a><a href="/apps">Internal apps</a><a href="/imports" aria-current="page">Imports</a></nav><h1>Import work</h1><p>Bring your projects, work, comments and files into {escape(identity["workspace_name"])}. Review every import before it changes your board.</p>
<ol class="setup-steps" aria-label="Import steps"><li id="import-step-source" aria-current="step">1. Choose source</li><li id="import-step-map">2. Map destination</li><li id="import-step-review">3. Review and import</li></ol><p id="import-message" role="status" aria-live="polite"></p>
<details id="import-source-panel" open><summary>Choose or change source</summary><section class="account-section"><h2>Connect a service</h2><div id="provider-buttons"></div><div id="connection-list"></div></section>
